...
const ListView = ({ setDetailId }) => {
  ...
  // slice methodunda  kullanıcak ilk elemanın state'i
  const [itemOffset, setItemOffset] = useState(0);

  // sayfa başına eleman sayısı
  const itemsPerPage = 10;

  // slice methodunda  kullanıcak son elemanın state'i
  ...
  const handlePageClick = (event) => {
    // yeni sayfadaki elek elemanın dizideki sırasını belirler
